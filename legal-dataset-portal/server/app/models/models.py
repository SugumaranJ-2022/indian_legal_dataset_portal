...
class Dataset(Base):
    ...
    provenance_strength = Column(String, default="Medium", nullable=True)
    ...
    source_url_status = Column(String, default="NOT_CHECKED", nullable=True)
    dataset_url_status = Column(String, default="NOT_CHECKED", nullable=True)
    license_url_status = Column(String, default="NOT_CHECKED", nullable=True)
    record_count_note = Column(String, nullable=True)
    ...
    reuse_recommendation = Column(String, default="STUDY ONLY", nullable=True)
    reuse_priority = Column(String, default="MEDIUM", nullable=True)
